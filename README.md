# MariaDB Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The MariaDB Trademarks Logo. They published great trademark guideline and also
supplying the required material files for it. The preferred version is `.svg`
...
This project re-draws MariaDB Trademarks Logo specifically for 1200x1200 size.
...
Since MariaDB published a list of detailed brand and trademark guideline, **you
MUST go through each of the following to avoid any unwanted legal
implications**:

* https://mariadb.com/about-us/logos
* https://mariadb.com/trademarks

While not specified by MariaDB, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: MariaDB Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-mariadb-1200x1200
UUID: EE7A0C1B-E508-4FDF-B12D-D89B1B51AD26
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-19
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-mariadb-1200x1200
--------------------------------------------------------------------------------
```
...
> COMPLY WITH MARIADB TRADEMARK REQUIREMENTS
> (Refer: https://mariadb.com/about-us/logos)**.
>
